...
ggplot(DataframeContingencia, 
       aes(x = Nivel_de_Renda, fill = Situacao_Pagamento)) +
  geom_bar(position = "dodge") +
  labs(title = "Renda vs Situação de Pagamento",
       x = "Nível de Renda",
       y = "Frequência",
       fill = "Situação")

### Exemplo Gráfico para Análise de Variáveis Qualitativas
